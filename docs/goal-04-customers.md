...
Goal 04 交付时顾客只等待订单。本分支的 Goal 05 已接入自动送餐、付款和离场：带着汉堡走到金色区域即可，详见 [Goal 05](goal-05-serving.md)。
...
上述记录为 Goal 04 的本机 Editor 验证。完整送餐付款循环在后续 Goal 05 的真实场景测试中连续完成三次；Android 构建、实机触控及长时间性能仍未验收。
