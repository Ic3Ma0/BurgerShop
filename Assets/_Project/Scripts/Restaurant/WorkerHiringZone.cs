...
namespace BurgerShop.Restaurant
{
    public sealed class WorkerHiringZone : MonoBehaviour
    {
        ...
        {
            if (station != null) colaGrill = station;
            if (pickup != null) colaPickup = pickup;
            if (cashier != null) colaServing = cashier;
            if (dropZone != null) colaDrop = dropZone;
        }
        ...
        public bool TryGetCollectTarget(out ProductionStation station, out Transform pickup) =>
            TryGetCollectTarget(null, out station, out pickup);
