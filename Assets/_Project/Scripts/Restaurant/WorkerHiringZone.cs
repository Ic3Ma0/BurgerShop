...
namespace BurgerShop.Restaurant
{
    public sealed class WorkerHiringZone : MonoBehaviour
    {
        ...
        public bool IsAvailable => MainHallExpansion.HasAccess && (GetComponent<UI.SessionGoalTracker>()?.Allows(ShopRanks.HireRank)??true) && isActiveAndEnabled && grill != null && grill.isActiveAndEnabled
