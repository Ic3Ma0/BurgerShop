...
namespace BurgerShop.Tests.EditMode
{
    public sealed class ShopLayoutTests
    {
        ...
        public void ZonesSitOnTheIntegerGrid()
        {
            ...
            Assert.That(ShopLayout.ColaPickup, Is.EqualTo(new Vector3(10.15f, 0.015f, 0.8f)));
            Assert.That(ShopLayout.ColaCounter, Is.EqualTo(new Vector3(3f, 0f, 4f)));
            Assert.That(ShopLayout.ColaServingCircle, Is.EqualTo(new Vector3(6.6f, 0.02f, 4f)));
            Assert.That(ShopLayout.ColaQueueEntry, Is.EqualTo(new Vector3(3f, 0f, -6f)));
            Assert.That(ShopLayout.ColaQueueSlots[0], Is.EqualTo(new Vector3(3f, 0f, 1.5f)));
            Assert.That(ShopLayout.ColaQueueSlots[1], Is.EqualTo(new Vector3(3f, 0f, -1.5f)));
            Assert.That(ShopLayout.ColaQueueSlots[2], Is.EqualTo(new Vector3(3f, 0f, -4.5f)));
        }
