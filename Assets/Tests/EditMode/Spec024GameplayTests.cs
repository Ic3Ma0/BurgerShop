...
namespace BurgerShop.Tests.EditMode
{
    public sealed class Spec024GameplayTests : SaveIsolatedGameplayTest
    {
        ...
        public IEnumerator SceneShortagesCompleteAtLastItemAndRestartKeepsOnlyPermanentProgress()
        {
            ...
            queue = Object.FindFirstObjectByType<CustomerQueue>(); queue.OrderQuantityFactory = () => 3;
            serving = Object.FindFirstObjectByType<BurgerServingZone>();
            grill = Object.FindFirstObjectByType<ProductionStation>();
