...
namespace BurgerShop.Tests.EditMode
{
    public sealed class RestroomTests:SaveIsolatedGameplayTest
    {
        ...
        [UnityTest] public IEnumerator StoreShowsLockAndCreditsPreviousInvestment()
        {
            ...
            Assert.That(buy.interactable,Is.False);Assert.That(buy.GetComponentInChildren<UnityEngine.UI.Text>().text,Does.Contain("Lv.4"));
            ...
            wallet.RestoreProgress(500,0);shop.Open();Assert.That(buy.GetComponentInChildren<UnityEngine.UI.Text>().text,Does.Contain("200 coins"));
            ...
            Assert.That(hits.Count,Is.GreaterThan(0));Assert.That(hits[0].gameObject,Is.EqualTo(buy.gameObject),"Lv12 restroom button must be visible and clickable above the cards");
