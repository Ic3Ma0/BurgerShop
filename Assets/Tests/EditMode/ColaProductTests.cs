...
namespace BurgerShop.Tests.EditMode
{
    public sealed class ColaProductTests
    {
        ...
        public void CarryHudAddsColaLineAndTaskCapsuleAsksForTheColaCounter()
        {
            ...
            Assert.That(label.text, Does.Contain("cola counter"));
        ...
        [Test]
        public void PersistenceWritesVersion8AndOldSavesKeepGrillProgressAtColaLv1()
        {
            ...
            try
            {
                ...
                persistence.Configure(wallet, burgerGrill.Upgrade, hiring, null, null, null, colaMachine.Upgrade,
                    directory);
