...
namespace BurgerShop.Tests.EditMode
{
    public sealed class SessionGoalTests
    {
        ...
        [Test]
        public void PickupStockAndServeAdvanceTheCapsuleAndStars()
        {
            tracker.Advance(2f);
            grill.Advance(12f);
